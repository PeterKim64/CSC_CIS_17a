 ...
 * Purpose: Project 2 for Lehr, create a card game:
 * I choose blackjack.
 */
/*
 * Version 4: Utilize classes to clean up main and main.cpp file. Create a deck
 * class that holds the deck. Create a Player class that has a hand, a name,
 * and have the choice to hit or stay. Create a dealer class that inherits player,
 * and can deal as well as shuffle. 
 */
...
int main(int argc, char** argv) {
    ...
    deck d;                     // deck class instantiation
